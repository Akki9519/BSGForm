...
//     if (file.size >  200 * 1024) { // Check if file size exceeds 200 KB
...
//      // Check if the uploaded photo exceeds the size limit
//      if (uploadPhoto && uploadPhoto.size > 200 * 1024) {
//       toast.error("Upload Photo size must be less than 200 KB.");
//       setLoading(false);
//       return;
//     }
//     if (uploadWarrant && uploadWarrant.size > 200 * 1024) {
//       toast.error("Upload Warrant size must be less than 200 KB.");
//       setLoading(false);
//       return;
//     }

//     // Check if the uploaded highest qualification exceeds the size limit
//     if (highestqualification && highestqualification.size > 200 * 1024) {
//       toast.error("Upload Highest Qualification size must be less than 200 KB.");
//       setLoading(false);
//       return;
//     }
...
//                   </label>
//                   <textarea
//                     type="text" value={currentAddress}
//                     disabled={courseDisable.length}
...
//                     onChange={(e) => handleFileChange(e.target.files[0], setUploadPhoto)}
//                   />
//                 </div>
//               </div>
...
//                     style={{ width: "300px" }}
//                     onChange={(e) => handleFileChange(e.target.files[0], setWarrantUpload)}
//                   />
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <label className="block text-sm font-bold text-black Upload Highest Qualification">Highest Qualification
//                   </label>
...
//                        accept="application/pdf"
//                     disabled={courseDisable.length}
//                     onChange={(e) => handleFileChange(e.target.files[0], setHighestQualification)}
...
const PersonalInformation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!uploadPhoto) newErrors.uploadPhoto = "Upload Photo is required!,File Size must be Greater than 200 KB";
if (!uploadWarrant) newErrors.uploadWarrant = "Upload Warrant is required!,File Size must be Greater than 200 KB";
if (!highestqualification) newErrors.highestqualification = "Highest Qualification is required!,,File Size must be Greater than 200 KB";
    ...
    if (revenuePincode === "") newErrors.revenuePincode = "Revenue Pincode is required.";
    if (revenueState === "") newErrors.revenueState = "Revenue State is required.";
    if (valid === "") newErrors.valid = "Valid Till date is required.";
    ...
    if (warrantNumber === "") newErrors.warrantNumber = "Warrant Number is required.";
  ...
  const getData = async () => {
    try {
      const userId = ls.get("_id");
      const response = await axios.get(`${BASE_URL}/api/v1/personaldetails/${userId}`,axiosConfig );
      const personalDetails = response.data;
      if (personalDetails && personalDetails.status === true) {
        setIsSubmitted(true);
      }
  ...
  return (
          ...
          <div className="pt-5 w-full rounded-lg shadow-md">
            <div className="px-8">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-0 lg:gap-10">
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <input
                    ...
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
                  />
                  {errors.bsgUid && <span className="text-red-500 text-sm">{errors.bsgUid}</span>}
                </div>
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">DOB</label>
                  <input
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10 ">
                ...
                {/* <div className ></div> */}
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Aadhar Number</label>
                  <input
                    type="text"
                    value={aadharNumber}
                    onChange={(e) => setAadharNumber(e.target.value)}
                ...
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Mobile Number</label>
                  <input
                    type="text"
                    value={mobileNumber}
                    onChange={(e) => setMobileNumber(e.target.value)}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10">
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Whatsapp Number</label>
                  <input
                    type="text"
                    value={whatsappNumber}
                    onChange={(e) => setWhatsAppNumber(e.target.value)}
                ...
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Current Address</label>
                  <textarea
                ...
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Permanent Address</label>
                  <textarea
                    value={permanentAddress}
                    onChange={(e) => setPermanentAddress(e.target.value)}
                    placeholder="Enter the Permanent Address"
                  ...
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      className="mr-2"
                    />
                    <label className="font-medium text-black">Same as Current Address</label>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10">
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Revenue State</label>
                  <select
                    value={revenueState}
                    onChange={(e) => setRevenueState(e.target.value)}
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
                  ...
                  {errors.revenueState && <span className="text-red-500 text-sm">{errors.revenueState}</span>}
                </div>

                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Revenue Pincode</label>
                  <input
                    type="text"
                    value={revenuePincode}
                    onChange={(e) => setRevenuePincode(e.target.value)}
                    ...
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
                  />
                  {errors.revenuePincode && <span className="text-red-500 text-sm">{errors.revenuePincode}</span>}
                </div>

                <div className="flex flex-col">
                  <label className="mb-1 font-medium text-black">Uploaded Photo</label>
                  {uploadPhoto1 && (
                    <img
                      src={uploadPhoto1}
                      alt="photo"
                  ...
                  <input
                    ...
                    onChange={(e) => handleFileChange(e.target.files[0], setUploadPhoto)}
                  />
                   {errors.uploadPhoto && <span className="text-red-500 text-sm">{errors.uploadPhoto}</span>}
                </div>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10">
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Marital Status</label>
                  <select
                    value={maritalStatus}
                    onChange={(e) => setMaritalStatus(e.target.value)}
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
                ...
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Occupation</label>
                  <select
                    value={occupation}
                    onChange={(e) => setOccupation(e.target.value)}
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10">
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Warrant Number</label>
                  <input
                    type="text"
                    value={warrantNumber}
                    onChange={(e) => setWarrantNumber(e.target.value)}
                    ...
                    className="outline-none bg-white rounded-md px-3 py-1 border border-gray-300 focus:border-indigo-500"
                  />
                  {errors.warrantNumber && <span className="text-red-500 text-sm">{errors.warrantNumber}</span>}
                </div>
                <div className="flex flex-col mb-4">
                ...
                <div className="flex flex-col mb-4">
    <label className="mb-1 font-medium text-black">Upload Warrant</label>
    {uploadWarrant1 && (
      <iframe
        src={uploadWarrant1}
        width="100%"
    ...
    <input
      ...
      className="outline-none mb-3 mt-1 py-2  px-2 block border-gray-300 w-32 rounded-md shadow-sm"
      style={{ width: "300px" }}
      onChange={(e) => handleFileChange(e.target.files[0], setWarrantUpload, "warrant")}
    />
    {errors.uploadWarrant && <span className="text-red-500 text-sm">{errors.uploadWarrant}</span>}
  </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-10">
                <div className="flex flex-col mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => setValidTill(e.target.value)}
                  />
                  {errors.valid && <span className="text-red-500 text-sm">{errors.valid}</span>}
                </div>
                <div className="flex flex-col mb-4">
                  <label className="mb-1 font-medium text-black">Qualification</label>
                  <select
                    value={qualification}
                    onChange={(e) => setQualification(e.target.value)}
                    className="outline-none bg-white rounded-md mb-3 px-3 py-1 border border-gray-300 focus:border-indigo-500"
                  >
                    ...
                    <option value="Graduate">Graduate</option>
                    <option value="Post Graduate">Post Graduate</option>
                    <option value="Phd /Higher Education">Phd /Higher Education</option>
                  </select>
                  {errors.qualification && <span className="text-red-500 text-sm">{errors.qualification}</span>}
                </div>
                <div>
                  <label className="block text-sm font-bold text-black">Highest Qualification</label>
                  {highestqualification1 && (
                    <iframe
                      src={highestqualification1}
                      width="100%"
